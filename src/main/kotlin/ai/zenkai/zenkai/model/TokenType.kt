...
enum class TokenType(private val lower: String, private val pretty: String, val authUrl: String) {
    TRELLO ("trello", "Trello", "https://trello.com/1/authorize?expiration=never&name=${i18n[S.NAME, i18n.default()]}&scope=read,write&response_type=fragment&key=$TRELLO_API_KEY"),
    TOGGL ("toggl", "Toggl", ""),
